Public Class MemberSearch
    ...
    Private Sub MemberEdit_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            Me.MemberTableTableAdapter1.Fill(Me.User_Story_ApplicationDataSet1.MemberTable)
    ...
    Private Sub MemberEdit_FormClosed(sender As Object, e As FormClosedEventArgs) Handles MyBase.FormClosed
        MainForm.SearchToolStripMenuItem.Enabled = True
    End Sub

    Private Sub TextBox6_TextChanged(sender As Object, e As EventArgs) Handles tbSearch.TextChanged
        Try
            MemberTableTableAdapter1.SearchMember(User_Story_ApplicationDataSet1.MemberTable, tbSearch.Text, tbSearch.Text)
        Catch ex As Exception
            MessageBox.Show(ex.Message)
        End Try
    End Sub
